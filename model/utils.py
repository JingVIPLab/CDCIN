...
def get_command_line_parser():
    ...
    parser.add_argument('--model_class', type=str, default='FEAT_Mlp_Res12', 
    ...
    parser.add_argument('--backbone_class', type=str, default='Mlp_Res12',
    ...
    #parser.add_argument('--init_weights', type=str, default='C:/Users/leg/Desktop/FEAT-master/feat-1-shot.pth' )# 是否加载FEAT训练的模型
    #parser.add_argument('--init_weights', type=str, default='/home/zxz/code/FEAT/initialization/miniimagenet/Res12-pre.pth' )# 是否加载Resnet12预训练的模型
    #parser.add_argument('--init_weights', type=str, default='/home/zxz/code/FEAT/initialization/tieredimagenet/Res12-pre.pth' )
    parser.add_argument('--init_weights', type=str, default='/home/zxz/code/FEAT/save/Pre_Mlp_Res12_0.0001_16_MiniImageNet_80_0/max_acc_dist_40.97708563506601.pth' )
